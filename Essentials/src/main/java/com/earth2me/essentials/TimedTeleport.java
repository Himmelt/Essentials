...
public class TimedTeleport implements Runnable {
    ...
    public TimedTeleport(com.earth2me.essentials.IUser user, IEssentials ess, Teleport teleport, long delay, com.earth2me.essentials.IUser teleportUser, ITarget target, Trade chargeFor, TeleportCause cause, boolean respawn) {
