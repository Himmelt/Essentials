...
public class SignProtection extends EssentialsSign {
    ...
    private void checkIfSignsAreBroken(final Block block, final User player, final String username, final com.earth2me.essentials.IEssentials ess) throws MaxMoneyException {
    ...
    @Override
    public boolean onBlockBreak(final Block block, final com.earth2me.essentials.IEssentials ess) {
    ...
    @Override
    public boolean onBlockExplode(final Block block, final com.earth2me.essentials.IEssentials ess) {
        final SignProtectionState state = isBlockProtected(block, null, null, false);
    ...
    @Override
    public boolean onBlockBurn(final Block block, final com.earth2me.essentials.IEssentials ess) {
        final SignProtectionState state = isBlockProtected(block, null, null, false);
    ...
    @Override
    public boolean onBlockIgnite(final Block block, final com.earth2me.essentials.IEssentials ess) {
        final SignProtectionState state = isBlockProtected(block, null, null, false);
