...
public class NumberUtil {
    ...
    public static String shortCurrency(final BigDecimal value, final com.earth2me.essentials.IEssentials ess) {
        return ess.getSettings().getCurrencySymbol() + formatAsCurrency(value);
    }
    ...
    public static String displayCurrency(final BigDecimal value, final com.earth2me.essentials.IEssentials ess) {
        return tl("currency", ess.getSettings().getCurrencySymbol(), formatAsCurrency(value));
    }
