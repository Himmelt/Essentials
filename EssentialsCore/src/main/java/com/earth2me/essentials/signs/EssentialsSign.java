...
public class EssentialsSign {
    ...
    protected final boolean onSignCreate(final SignChangeEvent event, final com.earth2me.essentials.IEssentials ess) {
    ...
    protected final boolean onSignInteract(final Block block, final Player player, final com.earth2me.essentials.IEssentials ess) {
    ...
    protected final boolean onSignBreak(final Block block, final Player player, final com.earth2me.essentials.IEssentials ess) throws MaxMoneyException {
        final ISign sign = new BlockSign(block);
        final User user = ess.getUser(player);
        try {
    ...
    protected boolean onSignInteract(final ISign sign, final User player, final String username, final com.earth2me.essentials.IEssentials ess) throws SignException, ChargeException, MaxMoneyException {
        return true;
    }

    protected boolean onSignBreak(final ISign sign, final User player, final String username, final com.earth2me.essentials.IEssentials ess) throws SignException, MaxMoneyException {
        return true;
    }

    protected final boolean onBlockPlace(final Block block, final Player player, final com.earth2me.essentials.IEssentials ess) {
    ...
    protected final boolean onBlockInteract(final Block block, final Player player, final com.earth2me.essentials.IEssentials ess) {
        User user = ess.getUser(player);
        try {
    ...
    protected final boolean onBlockBreak(final Block block, final Player player, final com.earth2me.essentials.IEssentials ess) throws MaxMoneyException {
        User user = ess.getUser(player);
        try {
    ...
    protected boolean onBlockBreak(final Block block, final com.earth2me.essentials.IEssentials ess) {
        return true;
    }

    protected boolean onBlockExplode(final Block block, final com.earth2me.essentials.IEssentials ess) {
        return true;
    }

    protected boolean onBlockBurn(final Block block, final com.earth2me.essentials.IEssentials ess) {
        return true;
    }

    protected boolean onBlockIgnite(final Block block, final com.earth2me.essentials.IEssentials ess) {
        return true;
    }

    protected boolean onBlockPush(final Block block, final com.earth2me.essentials.IEssentials ess) {
        return true;
    }
    ...
    protected boolean onBlockInteract(final Block block, final User player, final String username, final com.earth2me.essentials.IEssentials ess) throws SignException, ChargeException {
        return true;
    }
    ...
    protected final void validateTrade(final ISign sign, final int index, final com.earth2me.essentials.IEssentials ess) throws SignException {
    ...
    protected final void validateTrade(final ISign sign, final int amountIndex, final int itemIndex,
                                       final User player, final com.earth2me.essentials.IEssentials ess) throws SignException {
    ...
    protected final ItemStack getItemStack(final String itemName, final int quantity, final com.earth2me.essentials.IEssentials ess) throws SignException {
        try {
    ...
    protected final ItemStack getItemMeta(final ItemStack item, final String meta, final com.earth2me.essentials.IEssentials ess) throws SignException {
    ...
    protected final Trade getTrade(final ISign sign, final int index, final com.earth2me.essentials.IEssentials ess) throws SignException {
        return getTrade(sign, index, 1, ess);
    }

    protected final Trade getTrade(final ISign sign, final int index, final int decrement, final com.earth2me.essentials.IEssentials ess) throws SignException {
        final String line = getSignText(sign, index);
        if (line.isEmpty()) {
