...
public class TextInput implements IText {
    ...
    public TextInput(final CommandSource sender, final String filename, final boolean createFile, final IEssentials ess) throws IOException {
        this(sender, filename, createFile, (com.earth2me.essentials.IEssentials) ess);
    }

    public TextInput(final CommandSource sender, final String filename, final boolean createFile, final com.earth2me.essentials.IEssentials ess) throws IOException {
        File file = null;
        if (sender.isPlayer()) {
