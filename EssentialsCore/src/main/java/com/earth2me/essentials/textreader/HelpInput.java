...
public class HelpInput implements IText {
    ...
    public HelpInput(final User user, final String match, final IEssentials ess) {
        this(user, match, (com.earth2me.essentials.IEssentials) ess);
    }

    public HelpInput(final User user, final String match, final com.earth2me.essentials.IEssentials ess) {
