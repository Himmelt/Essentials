...
public class MetaItemStack {
    ...
    public boolean canSpawn(final com.earth2me.essentials.IEssentials ess) {
        try {
    ...
    public void addStringMeta(final CommandSource sender, final boolean allowUnsafe, final String string, final com.earth2me.essentials.IEssentials ess) throws Exception {
    ...
    public void addFireworkMeta(final CommandSource sender, final boolean allowShortName, final String string, final com.earth2me.essentials.IEssentials ess) throws Exception {
    ...
    public void addPotionMeta(final CommandSource sender, final boolean allowShortName, final String string, final com.earth2me.essentials.IEssentials ess) throws Exception {
    ...
    private void parseEnchantmentStrings(final CommandSource sender, final boolean allowUnsafe, final String[] split, final com.earth2me.essentials.IEssentials ess) throws Exception {
