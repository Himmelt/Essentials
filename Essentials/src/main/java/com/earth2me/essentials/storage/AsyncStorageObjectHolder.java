...
public abstract class AsyncStorageObjectHolder<T extends StorageObject> implements IConf, IStorageObjectHolder<T>, IReload {
    ...
    protected final transient com.earth2me.essentials.IEssentials ess;

    public AsyncStorageObjectHolder(final IEssentials ess, final Class<T> clazz) {
        this((com.earth2me.essentials.IEssentials) ess, clazz);
    }

    public AsyncStorageObjectHolder(final com.earth2me.essentials.IEssentials ess, final Class<T> clazz) {
        this.ess = ess;
        this.clazz = clazz;
        try {
