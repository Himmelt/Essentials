...
public class Trade {
    ...
    public Trade(final String command, final com.earth2me.essentials.IEssentials ess) {
        this(command, null, null, null, null, ess);
    }

    public Trade(final String command, final Trade fallback, final com.earth2me.essentials.IEssentials ess) {
        this(command, fallback, null, null, null, ess);
    }

    @Deprecated
    public Trade(final double money, final com.earth2me.essentials.IEssentials ess) {
        this(null, null, BigDecimal.valueOf(money), null, null, (com.earth2me.essentials.IEssentials) ess);
    }

    public Trade(final BigDecimal money, final com.earth2me.essentials.IEssentials ess) {
        this(null, null, money, null, null, ess);
    }

    public Trade(final ItemStack items, final com.earth2me.essentials.IEssentials ess) {
        this(null, null, null, items, null, ess);
    }

    public Trade(final int exp, final com.earth2me.essentials.IEssentials ess) {
    ...
    public void isAffordableFor(final com.earth2me.essentials.IUser user) throws ChargeException {
    ...
    public boolean pay(final com.earth2me.essentials.IUser user) throws MaxMoneyException {
        return pay(user, OverflowType.ABORT) == null;
    }

    public Map<Integer, ItemStack> pay(final com.earth2me.essentials.IUser user, final OverflowType type) throws MaxMoneyException {
    ...
    public void charge(final com.earth2me.essentials.IUser user) throws ChargeException {
        if (ess.getSettings().isDebug()) {
