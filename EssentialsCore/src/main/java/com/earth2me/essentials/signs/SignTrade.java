...
public class SignTrade extends EssentialsSign {
    ...
    private Trade rechargeSign(final ISign sign, final com.earth2me.essentials.IEssentials ess, final User player) throws SignException, ChargeException {
    ...
    protected final void validateTrade(final ISign sign, final int index, final boolean amountNeeded, final com.earth2me.essentials.IEssentials ess) throws SignException {
    ...
    protected final Trade getTrade(final ISign sign, final int index, final AmountType amountType, final boolean notEmpty, final com.earth2me.essentials.IEssentials ess) throws SignException {
        final String line = sign.getLine(index).trim();
        if (line.isEmpty()) {
            throw new SignException("Empty line");
        }
    ...
    protected final void subtractAmount(final ISign sign, final int index, final Trade trade, final com.earth2me.essentials.IEssentials ess) throws SignException {
    ...
    protected final void addAmount(final ISign sign, final int index, final Trade trade, final com.earth2me.essentials.IEssentials ess) throws SignException {
        final BigDecimal money = trade.getMoney();
        if (money != null) {
    ...
    private void changeAmount(final ISign sign, final int index, final BigDecimal value, final com.earth2me.essentials.IEssentials ess) throws SignException {
        final String line = sign.getLine(index).trim();
        if (line.isEmpty()) {
            throw new SignException("Empty line");
        }
