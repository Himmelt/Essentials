...
public class BanLookup {
    ...
    public static Boolean isBanned(com.earth2me.essentials.IEssentials ess, User user) {
        return isBanned(ess, user.getName());
    }
    ...
    public static Boolean isBanned(com.earth2me.essentials.IEssentials ess, String name) {
        return getBanEntry(ess, name) != null;
    }

    public static BanEntry getBanEntry(IEssentials ess, String name) {
        return getBanEntry((com.earth2me.essentials.IEssentials) ess, name);
    }

    public static BanEntry getBanEntry(com.earth2me.essentials.IEssentials ess, String name) {
